            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="{{route('all')}}"><i class="fa fa-circle-o"></i> All Loans</a></li>
                        <li><a href="{{route('pending')}}"><i class="fa fa-circle-o"></i> Pending Loans</a></li>
                        <li><a href="{{route('approved')}}"><i class="fa fa-circle-o"></i> Approved Loans</a></li>
                        <li><a href="{{route('refused')}}"><i class="fa fa-circle-o"></i> Refused Loans</a></li>
                        <li></li>
                    </ul>
                </li>
