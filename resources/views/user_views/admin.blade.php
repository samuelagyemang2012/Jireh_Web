...
<head>
    ...
    {{--<link rel="stylesheet" src="./assets/lib/font-awesome/fonts/fontawesome-webfont.eot">--}}
            <!-- Metis core stylesheet -->
    <link rel="stylesheet" href="{{asset('css/main.css')}}">
    {{--    href="{{asset('css/mycss.css')}}--}}
                    ...
                    <ul class="stats_box">
                        <li>
                            ...
                            <div class="stat_text">
                                ...
                                <span class="percent up"> 200</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="stat_text">
                                <strong>Loans</strong>
                                <span class="percent up">2000</span>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="stat_text">
                                ...
                                <span class="percent up"> 1000</span>
                            </div>
                        </li>
                        <!--<li>-->
